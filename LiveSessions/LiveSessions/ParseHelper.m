...
{
    UIAlertView *userNameAlert = [[UIAlertView alloc] initWithTitle:@"CrowdViz" message:@"Enter your name:" delegate:self cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
